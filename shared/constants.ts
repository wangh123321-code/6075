...
export const CAT_BREED_PRESETS: CatBreedPreset[] = [
  {
    ...
    imageUrl: 'https://loremflickr.com/100/100/persian,cat',
  },
  {
    ...
    imageUrl: 'https://loremflickr.com/100/100/british,shorthair,cat',
  },
  {
    id: 'maine-coon',
    name: '缅因猫',
    ...
    imageUrl: 'https://loremflickr.com/100/100/maine,coon,cat',
  },
  {
    id: 'sphynx',
    name: '无毛猫',
    ...
    imageUrl: 'https://loremflickr.com/100/100/sphynx,cat',
  },
  {
    id: 'ragdoll',
    name: '布偶猫',
    description: '半长毛、柔软、丝绸质感',
    hairParams: {
      length: 0.7,
      density: 0.75,
      stiffness: 0.3,
    ...
    imageUrl: 'https://loremflickr.com/100/100/ragdoll,cat',
  },
  {
    id: 'devon-rex',
    name: '德文卷毛猫',
    description: '短卷毛、柔软、波浪状',
    hairParams: {
      length: 0.3,
      density: 0.6,
      stiffness: 0.4,
    ...
    imageUrl: 'https://loremflickr.com/100/100/devon,rex,cat',
  },
];
